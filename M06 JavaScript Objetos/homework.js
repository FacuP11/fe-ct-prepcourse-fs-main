...
function pasarUsuarioAPremium(objetoMuchosUsuarios) {
   ...
   //objetoMuchosUsuarios = [{..., esPremium},{...,esPremium}]
...
function agregarMetodoCalculoDescuento(objetoProducto) {
   ...
   objetoProducto.calcularPrecioDescuento = function () { 
      ...
      var desc = objetoProducto.precio * objetoProducto.porcentajeDeDescuento
      
      objetoProducto["Precio Final"] = objetoProducto.precio - desc
